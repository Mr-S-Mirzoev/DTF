...
\AddToShipoutPictureFG{
  \AtPagemyUpperLeft{{\includegraphics[width=2.5cm,keepaspectratio]{figure/uzh_logo_e_neg.eps}}}
}%
...
\begin{table}
    ...
    \begin{tabular}{|c|c|}
        \hline
        \textbf{Measure} & \textbf{Result} \\ \hline % Header row
        Expected Annual Return & 9.82\% \\ \hline % Data rows with horizontal lines
